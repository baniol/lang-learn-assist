...
export function Layout({ currentView, onNavigate, children, settings, onSettingsChange, onQuickNoteOpen }: LayoutProps) {
        ...
        <nav className="flex-1 p-4 space-y-1">
          {navItems.map((item) => {
            const isActive =
              ...
              (item.id === "materials" && (currentView === "material-create" || currentView === "material-review"));
