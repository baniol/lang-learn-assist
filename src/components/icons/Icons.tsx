...
function createStrokeIcon(path: React.ReactNode, { viewBox = "0 0 24 24", strokeWidth = 2 } = {}) {
...
function createFillIcon(path: React.ReactNode, { viewBox = "0 0 24 24" } = {}) {
  return function Icon({ className, size = "md" }: IconProps) {
    return (
      <svg className={cn(sizeMap[size], className)} fill="currentColor" viewBox={viewBox}>
        {path}
      </svg>
    );
  };
...
export const PauseIcon = createFillIcon(<path d="M6 4h4v16H6V4zm8 0h4v16h-4V4z" />);
...
export const SendIcon = createStrokeIcon(<path d="M12 19l9 2-9-18-9 18 9-2zm0 0v-8" />);
...
export function PlayCircleIcon({ className, size = "md" }: IconProps) {
  return (
    <svg className={cn(sizeMap[size], className)} fill="currentColor" viewBox="0 0 24 24">
      <path
        fillRule="evenodd"
...
/**
 * Translate icon (language conversion arrows).
 */
export const TranslateIcon = createStrokeIcon(
 ...
 * Sort icon.
 */
export const SortIcon = createStrokeIcon(<path d="M3 4h13M3 8h9m-9 4h6m4 0l4-4m0 0l4 4m-4-4v12" />);
 ...
 * Clock/Time icon.
 */
export const ClockIcon = createStrokeIcon(<path d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />);
 ...
 * Tag icon.
 */
export const TagIcon = createStrokeIcon(
